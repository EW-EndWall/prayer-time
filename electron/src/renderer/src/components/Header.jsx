...
import icon from '/src/assets/img/favicon/android-chrome-192x192.png'
...
const Header = () => {
  ...
  return (
    <>
      <div className="flex justify-between items-center px-8 py-3 text-black dark:text-white bg-gray-400 dark:bg-gray-900">
        <Link to={'/'} className="capitalize font-semibold flex gap-3 items-center">
